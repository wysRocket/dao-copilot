...
const OptimizedTranscriptionApp: React.FC = () => {
  ...
  const { metrics: historicalMetrics, clearHistory, getAverageMetrics, getBestPerformance } = useStartupMetricsHistory()
  ...
  const getStatusColor = (phase: StartupPhase): string => {
    switch (phase) {
      case StartupPhase.IDLE: return 'bg-gray-100 text-gray-800'
      case StartupPhase.INITIALIZING: return 'bg-blue-100 text-blue-800'
      case StartupPhase.WEBSOCKET_CONNECTING: return 'bg-yellow-100 text-yellow-800'
      case StartupPhase.AUDIO_INITIALIZING: return 'bg-purple-100 text-purple-800'
      case StartupPhase.TRANSCRIPTION_INITIALIZING: return 'bg-orange-100 text-orange-800'
      case StartupPhase.READY: return 'bg-green-100 text-green-800'
      case StartupPhase.ERROR: return 'bg-red-100 text-red-800'
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              <div>
                ...
                <span className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(startupState.currentPhase)}`}>
              ...
              <div>
                ...
                <div className="mt-1">
                  ...
                  <span className="text-xs text-gray-500 mt-1">{startupState.progress}%</span>
                </div>
              </div>
        ...
        <div className="mt-8 bg-gray-100 rounded-lg p-6">
          ...
          <div className="prose prose-sm text-gray-700">
            ...
            <ul>
              <li><strong>Parallel Initialization:</strong> WebSocket, audio, and transcription components initialize simultaneously rather than sequentially</li>
              <li><strong>Component Pre-warming:</strong> Audio worklets and transcription buffers are pre-initialized to reduce startup latency</li>
              <li><strong>Reduced Timeouts:</strong> Connection timeouts optimized from 8s to 3s, audio init from 5s to 1s</li>
              <li><strong>Optimized Audio Context:</strong> Using 16kHz sample rate instead of 44.1kHz for faster initialization</li>
              <li><strong>Intelligent Fallback:</strong> Automatically falls back to sequential initialization if parallel fails</li>
            </ul>
            ...
            <ul>
              <li>Use the <code>useOptimizedStartup</code> hook for easy integration</li>
              <li>Enable <code>autoStartOnMount</code> for immediate startup</li>

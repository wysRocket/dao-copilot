...
export const useStreamingText = (
  ...
  const [connectionState, setConnectionStateInternal] = useState<StreamingTextState['connectionState']>('disconnected');
   ...
   */
  const updateText = useCallback((text: string, partial: boolean = false) => {

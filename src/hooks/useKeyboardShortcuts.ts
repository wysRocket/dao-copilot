...
export const useKeyboardShortcuts = (shortcuts: KeyboardShortcut[] = []) => {
  ...
  const defaultShortcuts: KeyboardShortcut[] = [
    ...
    },
    {
      ...
      modifiers: ['ctrl', 'shift'],
      action: async () => {
        const settingsWindows = portalManager.allWindows.filter(w => w.type === 'settings');
    ...
    },
    {
      ...
      modifiers: ['ctrl', 'shift'],
      action: async () => {
        const overlayWindows = portalManager.allWindows.filter(w => w.type === 'overlay');
    ...
    case 'overlay':
      shortcuts.push(
        ...
        },
        {
          ...
          action: () => {
            // Minimize overlay
            const minimizeButton = document.querySelector('[title*="minimize"]') as HTMLButtonElement;

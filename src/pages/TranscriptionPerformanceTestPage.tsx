...
const TranscriptionPerformanceTestPage: React.FC = () => {
  ...
  return (
    <div
      className="transcription-test-page"
    ...
    >
      ...
      {showInstructions && (
        ...
        >
          ...
          <ol>
            <li>
              <strong>Click "Start Recording"</strong> - This begins audio capture and WebSocket
              connection benchmarking
            </li>
            <li>
              <strong>Speak clearly</strong> - Say a few sentences to test transcription quality and
              speed
            </li>
            <li>
              <strong>Monitor metrics</strong> - Watch the real-time performance metrics below
            </li>
            <li>
              <strong>Click "Stop Recording"</strong> - This completes the benchmark and shows
              recommendations
            </li>
          </ol>
          ...
          <ul>
            <li>
              <strong>Audio Capture:</strong> Time to initialize microphone (~50ms target)
            </li>
            <li>
              <strong>WebSocket:</strong> Connection and first response time (~100ms target)
            </li>
            <li>
              <strong>Processing:</strong> Audio processing latency (~200ms target)
            </li>
            <li>
              <strong>Display:</strong> UI rendering time (~30ms target)
            </li>
            <li>
              <strong>Total:</strong> End-to-end latency (~380ms YouTube-like target)
            </li>
          </ul>
        ...
        <div>
          ...
          >
            ...
            <ul style={{fontSize: '14px'}}>
              <li>
                <strong>Audio Capture &gt; 100ms:</strong> Pre-warm AudioContext
              </li>
              <li>
                <strong>WebSocket &gt; 500ms:</strong> Connection pooling needed
              </li>
              <li>
                <strong>Processing &gt; 300ms:</strong> Use WebAssembly/Workers
              </li>
              <li>
                <strong>Display &gt; 50ms:</strong> Implement React.memo/virtualization
              </li>
            </ul>
          </div>
        </div>
      ...
      >
        <p style={{margin: 0, color: '#6c757d'}}>
          💡 <strong>Pro Tip:</strong> Run multiple tests to get accurate averages. Network
          conditions and system load can affect individual measurements.
        </p>
      </div>
    </div>
  )

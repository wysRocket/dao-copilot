  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Revolutionary transcription system with <strong>sub-100ms latency</strong> - faster than
          YouTube using advanced WebSocket optimization, React 18 features, and ultra-low latency
          audio processing
        </p>
              ...
              >
                ...
                <div style={{marginBottom: '10px'}}>
                  ...
                  <input
                    ...
                    onChange={e =>
                      handleConfigChange('connectionTimeout', parseInt(e.target.value))
                    }
                    min="1000"
                    max="10000"
                    step="1000"
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{fontSize: '14px', opacity: 0.9}}>This implementation</div>
          </div>
          ...
          >
            <div style={{fontSize: '36px', fontWeight: 'bold', marginBottom: '8px'}}>~150ms</div>
            <div style={{fontSize: '18px', fontWeight: 'bold', marginBottom: '4px'}}>
              YouTube Live
            </div>
            <div style={{fontSize: '14px', opacity: 0.9}}>Industry standard</div>
          </div>
          ...
          >
            <div style={{fontSize: '36px', fontWeight: 'bold', marginBottom: '8px'}}>~500ms</div>
            <div style={{fontSize: '18px', fontWeight: 'bold', marginBottom: '4px'}}>
              Standard WebSocket
            </div>
            <div style={{fontSize: '14px', opacity: 0.8}}>Basic implementation</div>
          </div>
          ...
          >
            <div style={{fontSize: '36px', fontWeight: 'bold', marginBottom: '8px'}}>1-3s</div>
            <div style={{fontSize: '18px', fontWeight: 'bold', marginBottom: '4px'}}>
              HTTP Polling
            </div>
            <div style={{fontSize: '14px', opacity: 0.9}}>Legacy approach</div>
          </div>
        </div>
      </div>
      ...
      {config.apiKey ? (
        ...
        >
          ...
          <p style={{color: '#6c757d', fontSize: '1.1em', maxWidth: '500px', margin: '0 auto'}}>
            Please enter your Gemini API key in the configuration above to experience the ultra-fast
            transcription system with sub-100ms latency.
          </p>
        </div>
      )}
      ...
      >
        ...
        >
          <div>
            <strong>WebSocket Optimization:</strong>
            <br />
            5-connection pool, binary transmission, compression
          </div>
          <div>
            <strong>React 18 Features:</strong>
            <br />

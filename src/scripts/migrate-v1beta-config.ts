...
async function runMigration(options: MigrationOptions = {}): Promise<void> {
  ...
  console.log('🚀 Gemini Live API v1beta Configuration Migration')
  console.log('================================================\n')
  ...
  if (!hasExistingConfig) {
    ...
    if (!options.dryRun) {
      ...
      console.log('✅ Created new .env file with v1beta configuration')
    } else {
      console.log('📋 Would create new .env file with:')
    ...
    console.log('🎯 Benefits of v1beta Migration:')
    migrationInfo.benefits.forEach(benefit => console.log(`  • ${benefit}`))
    console.log('')
    ...
    if (!options.dryRun) {
      ...
      console.log('✅ Updated .env file with v1beta configuration')
    } else {

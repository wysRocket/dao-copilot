  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background cursor-pointer transition-all duration-200 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        glass:
          'backdrop-blur-md border border-glass-border bg-glass-light text-primary hover:bg-glass-medium active:scale-95 shadow-lg',
        'glass-medium':
          'backdrop-blur-md border border-glass-border bg-glass-medium text-primary hover:bg-glass-heavy active:scale-95 shadow-lg',
        'glass-heavy':
          'backdrop-blur-md border border-glass-border bg-glass-heavy text-primary hover:brightness-110 active:scale-95 shadow-xl'
      },
      size: {

    ...
    >
      ...
      <div style={{ 
        ...
        <h2 style={{ margin: 0, color: '#2c3e50' }}>
          Optimized Live Transcription
        </h2>
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
          <span style={{ 
            fontSize: '12px', 
            color: getPerformanceStatus() === 'excellent' ? '#28a745' : 
                   getPerformanceStatus() === 'good' ? '#ffc107' : '#dc3545'
          }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {currentTranscription ? (
            <span>
              ...
              {currentTranscription.isPartial && (
        ...
        {currentTranscription && (
          <div style={{ 
            ...
            <span>
              Confidence: {((currentTranscription.confidence || 0) * 100).toFixed(1)}%
            </span>
            <span>
              Type: {currentTranscription.isPartial ? 'Partial' : 'Final'}
            </span>
            <span>
              Latency: {websocket.metrics?.averageLatency.toFixed(0) || 'N/A'}ms
            </span>
          </div>
        )}
      </div>
          ...
          <div style={{ 
            ...
            <div>
              ...
              {websocket.metrics.connectionTime ? 
                `${Date.now() - websocket.metrics.connectionTime}ms ago` : 'N/A'}
            </div>
          </div>

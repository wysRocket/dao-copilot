...
export const TextCorrectionDemo: React.FC = () => {
  ...
  const demoScenarios = [
    ...
    },
    {
      ...
      steps: [
        ...
        {
          text: 'The weather today is absolutely terrible, so I believe we should stay indoors',
          delay: 800
        },
        {
          text: 'The weather today is absolutely terrible, so I believe we should stay inside',
          delay: 1000
        }, // Word replacement
        {
          text: 'The weather today is absolutely terrible, so I believe we should stay inside.',
  ...
  return (
    <div
      className="text-correction-demo"
      style={{padding: '2rem', maxWidth: '800px', margin: '0 auto'}}
    >
      <h2 style={{marginBottom: '1.5rem', color: '#1f2937'}}>Text Correction Animation Demo</h2>
      ...
      >
        ...
        <p style={{color: '#075985', margin: 0}}>
          This demo showcases different types of text corrections including typo fixes, word
          replacements, sentence restructuring, and real-time speech recognition improvements.
        </p>
      </div>

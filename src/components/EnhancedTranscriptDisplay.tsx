...
export const EnhancedTranscriptDisplay: React.FC<EnhancedTranscriptDisplayProps> = ({
  ...
  }, [enableStreaming, websocketUrl, streamingState.connectionState, streamingControls, onStreamingError]);
  ...
  const renderConnectionStatus = useCallback(() => {
    ...
    const getStatusColor = () => {
      switch (streamingState.connectionState) {
        case 'connected': return 'var(--success-color, #00aa00)';
        case 'connecting':
        case 'reconnecting': return 'var(--warning-color, #ffaa00)';
        case 'error': return 'var(--error-color, #ff0000)';
      ...
      <div className="mb-2 flex items-center space-x-2">
        <div
          ...
          style={{
            ...
            animation: streamingState.connectionState === 'connecting' || streamingState.connectionState === 'reconnecting' 
  ...
  const renderStreamingStats = useCallback(() => {
    ...
    return (
      <div className="mt-2 text-xs opacity-50" style={{ color: 'var(--text-muted)' }}>
        Messages: {streamingState.messageStats.total} | 
        Partial: {streamingState.messageStats.partial} | 
        Final: {streamingState.messageStats.final} | 

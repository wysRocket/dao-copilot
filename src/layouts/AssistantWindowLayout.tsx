...
function AssistantContent() {
  ...
  // Assistant-specific status bar (below title bar)
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {windowState.localState.sidebarOpen && (
          <GlassCard
            variant="subtle"
            padding="p-3"
            className="w-48 rounded-none border-r border-white/10"
          >
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                {transcripts.slice(-5).map(transcript => (
                  <div
                    key={transcript.id}
                    className="cursor-pointer rounded p-2 text-xs transition-colors hover:bg-white/10"

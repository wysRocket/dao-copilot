...
describe('AccessibleStreamingText Component', () => {
  ...
  describe('Performance', () => {
    ...
    it('should handle rapid text updates', async () => {
      const { rerender } = render(
        <AccessibleStreamingText text="" announceChanges={false} />
      );
  ...
  describe('Memory Management', () => {
    it('should clean up resources on unmount', () => {
      const { unmount } = render(
        <AccessibleStreamingText text="Test" />
      );
    ...
    it('should handle multiple mount/unmount cycles', () => {
      for (let i = 0; i < 3; i++) {
        const { unmount } = render(
          <AccessibleStreamingText text={`Test ${i}`} />
        );
        unmount();
      }

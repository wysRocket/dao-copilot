...
describe('StreamingTextRenderer', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('should apply custom className', () => {
      ...
      render(<StreamingTextRenderer text="Test" className={customClass} />)
  ...
  describe('Text Formatting', () => {
    it('should render bold text when formatting is enabled', () => {
      render(<StreamingTextRenderer text="This is **bold** text" enableFormatting={true} />)

      expect(screen.getByText('bold')).toBeInTheDocument()
    })

    it('should handle text without formatting', () => {
      render(<StreamingTextRenderer text="Plain text content" enableFormatting={false} />)
  ...
  describe('Performance Features', () => {
    ...
    it('should handle rapid text updates', async () => {
      const {rerender} = render(<StreamingTextRenderer text="" animationSpeed={100} />)

      // Rapidly update text
      for (let i = 0; i < 10; i++) {
        await act(async () => {
          rerender(<StreamingTextRenderer text={`Text ${i}`} animationSpeed={100} />)
        })
      }
  ...
  describe('State Management', () => {
    it('should show state indicator when enabled', () => {
      render(<StreamingTextRenderer text="Test content" showStateIndicator={true} />)
    ...
    it('should handle partial text state', () => {
      render(<StreamingTextRenderer text="Partial text" isPartial={true} />)
    ...
    it('should handle complete text state', () => {
      render(<StreamingTextRenderer text="Complete text" isPartial={false} />)
  ...
  describe('Callbacks and Events', () => {
    it('should call onTextUpdate when text changes', async () => {
      ...
      const {rerender} = render(
        <StreamingTextRenderer text="Initial" onTextUpdate={onTextUpdate} />
      )

      await act(async () => {
        rerender(<StreamingTextRenderer text="Updated" onTextUpdate={onTextUpdate} />)
      })
    ...
    it('should call onStateChange when state changes', async () => {
      ...
      const {rerender} = render(
        <StreamingTextRenderer text="Test" isPartial={true} onStateChange={onStateChange} />
      )

      await act(async () => {
        rerender(
          <StreamingTextRenderer text="Test" isPartial={false} onStateChange={onStateChange} />
        )
      })
  ...
  describe('Typewriter Effects', () => {
    ...
    it('should show typewriter cursor', () => {
      render(<StreamingTextRenderer text="Test" enableTypewriterEffects={true} isPartial={true} />)
  ...
  describe('Memory Management', () => {
    it('should clean up resources on unmount', () => {
      const {unmount} = render(<StreamingTextRenderer text="Test" isPartial={true} />)
    ...
    it('should handle rapid mount/unmount cycles', () => {
      for (let i = 0; i < 10; i++) {
        const {unmount} = render(<StreamingTextRenderer text={`Test ${i}`} />)
        unmount()
      }
  ...
  describe('Custom Styling', () => {
    it('should apply custom partial styles', () => {
      ...
      render(<StreamingTextRenderer text="Test" isPartial={true} partialStyle={partialStyle} />)
    ...
    it('should apply custom final styles', () => {
      ...
      render(<StreamingTextRenderer text="Test" isPartial={false} finalStyle={finalStyle} />)

...
const TestStreamingTextRenderer: React.FC<TestComponentProps> = ({
  ...
  return (
    ...
    >
      {showStateIndicator && <div data-testid="state-indicator" />}

      <span className="streaming-text-content">
        {processText(text || '')}
        {enableTypewriterEffects && <span className="typewriter-cursor">|</span>}
      </span>
...
describe('StreamingTextRenderer', () => {
  ...
  describe('Text Formatting', () => {
    it('should render bold text when formatting is enabled', () => {
      render(<TestStreamingTextRenderer text="This is **bold** text" enableFormatting={true} />)

      expect(screen.getByText(/bold/)).toBeInTheDocument()
    })

    it('should handle text without formatting', () => {
      render(<TestStreamingTextRenderer text="Plain text content" enableFormatting={false} />)
  ...
  describe('Callback Functions', () => {
    ...
    it('should call onTextUpdate when text changes', async () => {
      ...
      const {rerender} = render(
        <TestStreamingTextRenderer text="Initial" onTextUpdate={onUpdate} />
      )

      rerender(<TestStreamingTextRenderer text="Updated" onTextUpdate={onUpdate} />)
  ...
  describe('Performance Optimization', () => {
    it('should handle frequent updates without memory leaks', () => {
      const {rerender, unmount} = render(<TestStreamingTextRenderer text="Initial" />)
  ...
  describe('Integration Features', () => {
    it('should work with state indicator when enabled', () => {
      render(<TestStreamingTextRenderer text="Test" showStateIndicator={true} />)
    ...
    it('should apply custom className', () => {
      render(<TestStreamingTextRenderer text="Test" className="custom-class" />)
    ...
    it('should handle typewriter effects when enabled', () => {
      render(<TestStreamingTextRenderer text="Typewriter test" enableTypewriterEffects={true} />)
